...
str013_help() {
	echo 'Pads end of string/file with sequence until length is reached.'
	echo 'Parameters:'
	echo ' - base string'
...
str013_examples() {
	echo 'teststring=$(shlibs str013 "Base string" "." 24)'
...
str013_tests() {
	tests__='
res=$(shlibs str013 "Base string" "." 24) ; echo "${#res}${res#Base string}"
=======
24.............
'
	echo "${tests__}"
